...
#### Daily Updates:
- [Saturday 12/3/21]: IntelliJ compilation issue resolved, solution recorded: [R&D Technical Paper](https://github.com/jeyakatsa/Altair----Minimal-Light-Client-Prototype/blob/main/Teku-Light-Client-Server-R%26D.md). Eclipse removed as coding tool from [Readme](https://github.com/jeyakatsa/Altair----Minimal-Light-Client-Prototype/blob/main/README.md) & [Step-By-Step Guide](https://hackmd.io/ZFINvY5fRUGrLK-BteZrug?view) (as was the primary arbiter of compilation issues for IntelliJ). Light-Client Module refactored from Eclipse for IntelliJ, currently resolving import issues: [Light-Client Server "Module"](https://github.com/jeyakatsa/teku/tree/master/light-client).
- [Friday 12/2/21]: New trial & error approach being implemented to resolve compilation issues, results recorded: [R&D Technical Paper](https://github.com/jeyakatsa/Altair----Minimal-Light-Client-Prototype/blob/main/Teku-Light-Client-Server-R%26D.md).
